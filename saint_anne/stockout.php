...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `stock_out`(`Product_Id_out`, `Quantity_out`) VALUES ('$id','$quantity')";
    $query = mysqli_query($conn, $sql);

    if ($query) {
        $message = "<div class='alert alert-success'>✅ Data successfully inserted.</div>";
    } else {
        $message = "<div class='alert alert-danger'>❌ Data not inserted: " . mysqli_error($conn) . "</div>";
    }
}
?>
...
<div class="form-container">
    <h2 class="form-title">📦 Stock Out Entry</h2>
    ...
    <form action="" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="quantity" class="form-control" placeholder="Enter Quantity Out" required>
        </div>

        <div class="d-flex justify-content-between">
            <button type="submit" name="submit" class="btn btn-primary">Submit</button>
            <a href="stockout_select.php" class="btn btn-secondary">View Data</a>
        </div>
    </form>
</div>
